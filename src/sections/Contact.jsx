...
const contactItems = [
  ...
  },
  {
    ...
    label: 'WhatsApp',
    value: '+91 9959575926',
    href: 'https://wa.me/919959575926?text=Hi%2C%20I%20want%20to%20order%20from%20Pooja%20Artisan%20Chocolates!',
    icon: (
      <svg viewBox="0 0 24 24" fill="currentColor" className="w-6 h-6">
  ...
  },
  {
    id: 'email-link',
    label: 'Email',
    value: 'poojasartisanchoco.co@gmail.com',
    href: 'mailto:poojasartisanchoco.co@gmail.com',
    icon: (
              ...
              >
                ...
                <div>
                  <label
                    ...
                    className="block font-sans text-xs text-cream/60 tracking-wider uppercase mb-2"
                  >
                    Email
                  </label>
                  <input
