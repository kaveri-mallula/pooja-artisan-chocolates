          ...
          <div>
            ...
            <div className="space-y-4">
              ...
              <div>
                ...
                <a href="https://wa.me/919999999999" target="_blank" rel="noopener noreferrer" className="font-sans text-sm text-cream/60 hover:text-gold transition-colors duration-200">
                  +91 99999 99999
                </a>
              </div>
              <div>
                <p className="font-sans text-xs text-cream/35 uppercase tracking-wider mb-1">Email</p>
                <a href="mailto:hello@artisanchoco.co" className="font-sans text-sm text-cream/60 hover:text-gold transition-colors duration-200">
                  hello@artisanchoco.co
                </a>
              </div>
              <div>
